...
Защита класса от других воздействий. Пользователь класса должен видеть только список декларируемых свойств и методов и не вникать во внутренную реализацию.
