...
- часто используемые архитектурные паттерны (MVC family) MVC-90% проектов, т.к. большинство программистов использует вообще, хорошо для бизнес приложения но сложно применимо к геймдеву потому что сущности должны знать о других сущностях, появляются грабли, MVVM MVP
