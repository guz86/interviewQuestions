...
Принцип подстановки Барбары Лисков. Если вызывающий код ожидает некий базовый тип, то при передачи туда наследника не должно возникнуть никаких сайд эффектов. Старый код должен продолжать работать как и прежде. 
